...
\usetheme{CambridgeMod}
\rhbClassification{Offen}
...
\newcommand{\subsec}[1]{\subsubsection{#1} \renewcommand{\subsectiontitle}{#1}}
...
%\fancyhead{}
%\fancyfoot{}
%\lhead{\changefont $title$}
%\chead{\changefont $author$}
%\rhead{\changefont $date$}
%\lfoot{$for(author)$$author$$sep$, $endfor$}
%\lfoot{\changefont \subsectiontitle}
...
%\setbeamercolor{section number projected}{bg=green,fg=black}
%\setbeamertemplate{subsection in toc}[circle]
%\setbeamerfont{subsection number projected}{size=\small}
%\setbeamercolor{subsection number projected}{bg=green,fg=black}
